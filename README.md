...
![Build](https://github.com/DC-fan/plugin/workflows/Build/badge.svg)
...
- Manually:
  ...
  Download the [latest release](https://github.com/DC-fan/plugin/releases/latest) and install it manually using
